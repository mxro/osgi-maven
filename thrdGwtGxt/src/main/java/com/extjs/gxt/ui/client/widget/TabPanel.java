...
public class TabPanel extends Container<TabItem> {
  ...
  protected void focusTab(TabItem item, boolean setFocus) {
  ...
  protected void renderItem(TabItem item, int index) {
    if (item.header.isRendered()) {
