...
public class TreeItem extends Component {
  ...
  protected void clearCheckChildren(TreeItem parent) {
  ...
  protected void expandChildren(boolean deep) {
    for (int i = 0; i < getItemCount(); i++) {
      TreeItem item = getItem(i);
  ...
  protected void getAllChildren(List<TreeItem> list, TreeItem parent) {
    list.add(parent);
