...
public class TemplatesGenerator extends Generator {
  ...
  public static class SourceGenerator {
    ...
    protected void validateType() throws UnableToCompleteException {
    ...
    protected void createMarkupMethod(JMethod method) throws UnableToCompleteException {
    ...
    protected void createTemplatesMethod(JMethod method) throws UnableToCompleteException {
    ...
    protected void generateReturnsMarkupMethod(JMethod method, boolean cache, String content,
    ...
    protected void generateResultBody(String content) throws UnableToCompleteException {
  ...
  public static class TemplateToJavaSourceConverter {
    ...
    protected void convert() throws UnableToCompleteException {
    ...
    protected void generateCode(String code) throws UnableToCompleteException {
      switch (codeType) {
        case '%':
        case '{':
    ...
    protected void generateFMCode(String code) throws UnableToCompleteException {
    ...
    protected void fmElseif(String parameters) {
      sw.outdent();
      sw.print("} else if (");
      sw.print(parameters);
      sw.println(") {");
    ...
    protected void fmElse(String parameters) {
      sw.println("} else {");
    }

    protected void fmList(String parameters) throws UnableToCompleteException {
    ...
    protected void analyseIterable() {
      // Is it a range?
    ...
    protected void fmEnd(String parameters) {
      sw.println("}");
      sw.outdent();
    }

    protected void fmIf(String parameters) {
      sw.print("if (");
      sw.print(parameters);
      sw.println(") {");
      sw.indent();
    ...
    protected void generateJspCode(String code) {
