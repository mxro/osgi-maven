...
public class DragSource extends BaseObservable {
  ...
  protected void onDraggableDragCancel(DragEvent de) {
  ...
  protected void onDraggableDragEnd(DragEvent de) {
  ...
  protected void onDraggableDragMove(DragEvent de) {
  ...
  protected void onDraggableDragStart(DragEvent de) {
    DNDEvent e = new DNDEvent(this, de.getEvent());
    e.setData(data);
    e.setDragEvent(de);
    e.setComponent(component);
