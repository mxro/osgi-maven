...
public class TreeStore<M extends ModelData> extends Store<M> {
  ...
  @SuppressWarnings({"unchecked", "rawtypes"})
  protected void doInsert(TreeModel parent, List<TreeModel> children, int index, boolean addChildren, boolean supressEvent) {
  ...
  protected void filterTreeWrap(TreeModel wrap) {
  ...
  protected void findChildren(M parent, List<M> children) {
  ...
  protected void remove(TreeModel parent, TreeModel child, boolean supressEvent) {
  ...
  protected void removeAll(boolean supressEvent) {
    for (M m : all) {
      unregisterModel(m);
    }
    all.clear();
