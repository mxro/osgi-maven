...
import de.mxro.thrd.hamcrest.internal.ArrayIterator;
import de.mxro.thrd.hamcrest.internal.SelfDescribingValueIterator;
...
public abstract class BaseDescription implements Description {
    ...
    protected void toJavaSyntax(String unformatted) {
        append('"');
    ...
    protected void toJavaSyntax(char ch) {
        switch (ch) {
            case '"':
                append("\\\"");
                break;
