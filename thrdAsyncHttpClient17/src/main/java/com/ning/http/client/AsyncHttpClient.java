...
public class AsyncHttpClient {
     ...
     */
    public AsyncHttpClient(final AsyncHttpProvider provider) {
     ...
     */
    public AsyncHttpClient(final AsyncHttpClientConfig config) {
     ...
     */
    public AsyncHttpClient(final AsyncHttpProvider httpProvider, final AsyncHttpClientConfig config) {
        this.config = config;
     ...
     */
    public AsyncHttpClient(final String providerClass, final AsyncHttpClientConfig config) {
    ...
    public class BoundRequestBuilder extends RequestBuilderBase<BoundRequestBuilder> {
        ...
        private BoundRequestBuilder(final String reqType, final boolean useRawUrl) {
            super(BoundRequestBuilder.class, reqType, useRawUrl);
        }

        private BoundRequestBuilder(final Request prototype) {
            super(BoundRequestBuilder.class, prototype);
        }

        public <T> ListenableFuture<T> execute(final AsyncHandler<T> handler) throws IOException {
        ...
        @Override
        public BoundRequestBuilder addBodyPart(final Part part) throws IllegalArgumentException {
            return super.addBodyPart(part);
        }

        @Override
        public BoundRequestBuilder addCookie(final Cookie cookie) {
            return super.addCookie(cookie);
        }

        @Override
        public BoundRequestBuilder addHeader(final String name, final String value) {
            return super.addHeader(name, value);
        }

        @Override
        public BoundRequestBuilder addParameter(final String key, final String value) throws IllegalArgumentException {
            return super.addParameter(key, value);
        }

        @Override
        public BoundRequestBuilder addQueryParameter(final String name, final String value) {
        ...
        @Override
        public BoundRequestBuilder setBody(final byte[] data) throws IllegalArgumentException {
            return super.setBody(data);
        }

        @Override
        public BoundRequestBuilder setBody(final EntityWriter dataWriter, final long length) throws IllegalArgumentException {
            return super.setBody(dataWriter, length);
        }

        @Override
        public BoundRequestBuilder setBody(final EntityWriter dataWriter) {
            return super.setBody(dataWriter);
        }

        @Override
        public BoundRequestBuilder setBody(final InputStream stream) throws IllegalArgumentException {
            return super.setBody(stream);
        }

        @Override
        public BoundRequestBuilder setBody(final String data) throws IllegalArgumentException {
            return super.setBody(data);
        }

        @Override
        public BoundRequestBuilder setHeader(final String name, final String value) {
            return super.setHeader(name, value);
        }

        @Override
        public BoundRequestBuilder setHeaders(final FluentCaseInsensitiveStringsMap headers) {
            return super.setHeaders(headers);
        }

        @Override
        public BoundRequestBuilder setHeaders(final Map<String, Collection<String>> headers) {
            return super.setHeaders(headers);
        }

        @Override
        public BoundRequestBuilder setParameters(final Map<String, Collection<String>> parameters) throws IllegalArgumentException {
            return super.setParameters(parameters);
        }

        @Override
        public BoundRequestBuilder setParameters(final FluentStringsMap parameters) throws IllegalArgumentException {
            return super.setParameters(parameters);
        }

        @Override
        public BoundRequestBuilder setUrl(final String url) {
            baseURL = url;
            return super.setUrl(url);
        }

        @Override
        public BoundRequestBuilder setVirtualHost(final String virtualHost) {
            return super.setVirtualHost(virtualHost);
        }

        public BoundRequestBuilder setSignatureCalculator(final SignatureCalculator signatureCalculator) {
     ...
     */
    public AsyncHttpClient setSignatureCalculator(final SignatureCalculator signatureCalculator) {
        this.signatureCalculator = signatureCalculator;
        return this;
    }
     ...
     * @throws IOException
     */
    public <T> ListenableFuture<T> executeRequest(final Request request, final AsyncHandler<T> handler) throws IOException {
     ...
     * @throws IOException
     */
    public ListenableFuture<Response> executeRequest(final Request request) throws IOException {
    ...
    private final static AsyncHttpProvider loadDefaultProvider(final String className, final AsyncHttpClientConfig config) {
        try {
            final Class<AsyncHttpProvider> providerClass = (Class<AsyncHttpProvider>) Thread.currentThread()
            ...
            try {
                final Class<AsyncHttpProvider> providerClass = (Class<AsyncHttpProvider>)
    ...
    protected BoundRequestBuilder requestBuilder(final String reqType, final String url) {
