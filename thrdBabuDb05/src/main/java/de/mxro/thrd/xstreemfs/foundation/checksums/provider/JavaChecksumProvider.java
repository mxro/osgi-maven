...
package de.mxro.thrd.xstreemfs.foundation.checksums.provider;

import de.mxro.thrd.xstreemfs.foundation.checksums.ChecksumProvider;
...
public class JavaChecksumProvider extends ChecksumProvider {
	...
	public JavaChecksumProvider() {
		...
		addAlgorithm(new de.mxro.thrd.xstreemfs.foundation.checksums.algorithms.Adler32());
		addAlgorithm(new de.mxro.thrd.xstreemfs.foundation.checksums.algorithms.CRC32());
		/*try {
		...
		addAlgorithm(new de.mxro.thrd.xstreemfs.foundation.checksums.algorithms.JavaHash());
	}
