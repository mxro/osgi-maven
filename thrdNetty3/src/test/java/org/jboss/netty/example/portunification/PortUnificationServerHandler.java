...
public class PortUnificationServerHandler extends FrameDecoder {
    ...
    protected void enableSsl(ChannelHandlerContext ctx) {
    ...
    protected void enableGzip(ChannelHandlerContext ctx) {
        ChannelPipeline p = ctx.getPipeline();
    ...
    protected void switchToFactorial(ChannelHandlerContext ctx) {
        ChannelPipeline p = ctx.getPipeline();
